...
"font: 12pt \"Cantarell\";")
    ...
    def retranslateUi(self, TableDialog2):
        ...
        item.setText(_translate("TableDialog2", "День рождения"))
        item = self.selectTableWidget.horizontalHeaderItem(3)
        item.setText(_translate("TableDialog2", "Месяц рождения"))
        item = self.selectTableWidget.horizontalHeaderItem(4)
        item.setText(_translate("TableDialog2", "Год рождения"))
