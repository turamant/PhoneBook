...
class Ui_TableDialog2(object):
    def setupUi(self, TableDialog2):
        ...
        self.displayRowspushButton = QtWidgets.QPushButton(TableDialog2)
...
"color: blue;")
        ...
        self.selectTableWidget.setGeometry(QtCore.QRect(140, 20, 691, 521))
        ...
        self.nameLineEdit2 = QtWidgets.QLineEdit(TableDialog2)
...
"color: rgb(0, 85, 0);")
    ...
    def retranslateUi(self, TableDialog2):
        ...
        self.displayRowspushButton.setText(_translate("TableDialog2", "Показать все записи"))
        self.HeadLabel.setText(_translate("TableDialog2", "Зашли как"))
        self.ABsearchPushButton_1.setText(_translate("TableDialog2", "АБ"))
        self.nameLineEdit.setPlaceholderText(_translate("TableDialog2", "   Введите имя"))
        self.nameLineEdit2.setPlaceholderText(_translate("TableDialog2", "   Введите имя"))
