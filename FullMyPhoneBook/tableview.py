...
"font: 12pt \"Cantarell\";")
        ...
        self.selectTableWidget.setGeometry(QtCore.QRect(140, 50, 1001, 751))
        ...
        self.AZsearchPushButton_14.setGeometry(QtCore.QRect(20, 570, 113, 36))
    ...
    def retranslateUi(self, TableDialog):
        ...
        item.setText(_translate("TableDialog", "Год"))
        item = self.selectTableWidget.horizontalHeaderItem(3)
        item.setText(_translate("TableDialog", "Месяц"))
        item = self.selectTableWidget.horizontalHeaderItem(4)
        item.setText(_translate("TableDialog", "День"))
