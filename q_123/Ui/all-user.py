...
# Form implementation generated from reading ui file 'all-user.ui'
#
...
class Ui_BirthDayTableDialog(object):
    def setupUi(self, BirthDayTableDialog):
        ...
        self.userTableWidget = QtWidgets.QTableWidget(BirthDayTableDialog)
...
"color: rgb(43, 0, 255);")
    ...
    def retranslateUi(self, BirthDayTableDialog):
        ...
        item.setText(_translate("BirthDayTableDialog", "E-mail"))
        item = self.userTableWidget.horizontalHeaderItem(1)
        item.setText(_translate("BirthDayTableDialog", "Password"))
        item = self.userTableWidget.horizontalHeaderItem(2)
        item.setText(_translate("BirthDayTableDialog", "Save"))
        ...
        self.headLabe.setText(_translate("BirthDayTableDialog", "Все пользователи программы"))
